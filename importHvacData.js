...
async function importHvacData() {
  const results = [];
  const filePath = path.join(__dirname, 'Untitled spreadsheet - Generated by Outscraper ©.csv');
  // If the file isn't in the root directory, you might need to adjust this path
  // Possible alternatives:
  // const filePath = path.join(__dirname, 'attached_assets', 'Untitled spreadsheet - Generated by Outscraper ©.csv');
  // or manually place the CSV file in the root directory
